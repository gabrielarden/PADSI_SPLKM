<aside class="navbar navbar-vertical navbar-expand-lg">
    <div class="container-fluid">
        ...
        <div class="navbar-brand navbar-brand-autodark">
            <a href="{{ route('dashboard') }}" aria-label="{{ $websiteSetting?->website_name ?? 'POS KEDAI MATARI' }}">
                ...
                @else
                {{ $websiteSetting?->website_name ?? 'POS KEDAI MATARI' }}
                @endif
            </a>
        </div>
        <!-- END NAVBAR LOGO -->
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item {{ request()->is('membership*') ? 'active' : '' }}"
                                    href="{{ route('membership.index') }}"> Membership </a>
                                @endcan
                                @can('role.view')
